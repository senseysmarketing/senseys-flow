    ...
    backgroundImage: `url(${backgroundImage})`
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        <div className="text-center space-y-4">
          <img src={logo} alt="Senseys - Marketing Imobiliário" className="mx-auto h-16 w-auto object-contain" />
        </div>

        {showResetPassword ? <Card>
            <CardHeader>
          ...
          </Card> : <Tabs defaultValue="signin" className="w-full">
                ...
                <CardContent>
                  <form onSubmit={handleSignIn} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input id="signin-email" type="email" value={signInData.email} onChange={e => setSignInData({
                    ...signInData,
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="signin-password" type="password" value={signInData.password} onChange={e => setSignInData({
                    ...signInData,
                    ...
                    <Button type="button" variant="link" className="w-full text-sm" onClick={() => setShowResetPassword(true)}>
                      Esqueceu a senha?
                    </Button>
                  </form>
                </CardContent>
                ...
                <CardContent>
                  <form onSubmit={handleSignUp} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input id="signup-name" type="text" value={signUpData.fullName} onChange={e => setSignUpData({
                    ...signUpData,
